...
// this file only exists because of circular imports - the subclass extends this but the worker
// stuff imports them so we end up with big buh moments
